...
then
	...
	libtbb-dev libnss3-dev libudev-dev libpulse-dev libpcre2-dev libasound2-dev libgl1-mesa-dev libssh-dev libmaxminddb-dev libopus-dev psmisc sshpass tcpdump -y
	# folly requirements
...
then
	...
	sudo apt update
	sudo apt install -y g++ software-properties-common kmod libglib2.0-dev libsnappy1v5 libsmi2ldbl liblua5.2-0 libc-ares2 libnl-route-3-200 libnl-genl-3-200 \
	libfreetype6 graphviz libtbb2 libxss1 libnss3 libspandsp2 libsbc1 libbrotli1 libnghttp2-14 libasound2 psmisc sshpass \
	libpulse0 libasound2 libpcre2-dev libmaxminddb0 libopus0 libspeex1 bc tcpdump \
	libgoogle-glog0v5 libgflags2.2 libzstd1 libunwind8 libcap2 libspeexdsp1
	...
	then
		...
		then
			...
			then
				...
				sudo apt install -y ./libssl1.1_1.1.1-1ubuntu2.1~18.04.21_amd64.deb
