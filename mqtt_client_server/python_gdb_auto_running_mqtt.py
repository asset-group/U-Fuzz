...
def create_timestamp_log():
    ...
    # EMQX file name
     file_name = "/home/asset/Desktop/work/wireless-deep-fuzzer-zigbee/mqtt_log/emqx/time_stamp_log/time_stamp_log_"+current_time+".txt"
    # hivemq-ce file name
...
def create_output_log():
    ...
    # EMQX file name
     file_name = "/home/asset/Desktop/work/wireless-deep-fuzzer-zigbee/mqtt_log/emqx/output_log/output_log_"+current_time+".txt"
    # hivemq-ce file name
