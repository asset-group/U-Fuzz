...
namespace quicktype {
    ...
    enum class StateNameField : int { COAP_TYPE };
...
namespace nlohmann {
    ...
    void from_json(const json & j, quicktype::StateNameField & x);
    void to_json(json & j, const quicktype::StateNameField & x);
    ...
    inline void from_json(const json & j, quicktype::StateNameField & x) {
        if (j == "coap.type") x = quicktype::StateNameField::COAP_TYPE;
        else throw "Input JSON does not conform to schema";
    }

    inline void to_json(json & j, const quicktype::StateNameField & x) {
        switch (x) {
            case quicktype::StateNameField::COAP_TYPE: j = "coap.type"; break;
...
const char *default_config = R"/({
    "config": {
        ...
        "Options": {
            ...
            "AutoStart": true,
            "CoreDump": true,
            "DefaultPCAPProtocol": "proto:eth",
            "DefaultPrograms": [
                "bin/gatt_browser"
            ],
            "DefaultProtocol": "proto:eth",
            "FileLogger": true,
            "GlobalTimeout": 10,
            "LiveCapture": false,
            "MainThreadCore": -1,
        ...
        "StateMapper": {
            ...
            "Mapping": [

                {
                    "AppendSummary": false,
                    "Filter": "coap.code==1",
                    "LayerName": "ConfirmableGet",
                    "StateNameField": "coap.type"
                },
                {
                    "AppendSummary": false,
                    "Filter": "coap.type==0&&coap.code==0",
                    "LayerName": "ConfirmableEmpty",
                    "StateNameField": "coap.type"
                },
                {
                    "AppendSummary": false,
                    "Filter": "coap.code==2",
                    "LayerName": "ConfirmablePost",
                    "StateNameField": "coap.type"
                },
                {
                    "AppendSummary": false,
                    "Filter": "coap.code==3",
                    "LayerName": "ConfirmablePut",
                    "StateNameField": "coap.type"
                },
                {
                    "AppendSummary": false,
                    "Filter": "coap.code==4",
                    "LayerName": "ConfirmableDelete",
                    "StateNameField": "coap.type"
                },
                {
                    "AppendSummary": false,
                    "Filter": "coap.type==1",
                    "LayerName": " NonConfirmableSuccContent",
                    "StateNameField": "coap.type"
                },
                {
                    "AppendSummary": false,
                    "Filter": "coap.type==2&&coap.code==69",
                    "LayerName": "AckSuccContent",
                    "StateNameField": "coap.type"
                },
                {
                    "AppendSummary": false,
                    "Filter": "coap.code==133",
                    "LayerName": "AckMethodNotFound",
                    "StateNameField": "coap.type"
                },
                {
                    "AppendSummary": false,
                    "Filter": "coap.code==132",
                    "LayerName": "AckNotFound",
                    "StateNameField": "coap.type"
                },
                {
                    "AppendSummary": false,
        ...
        "Validation": {
            ...
            "DefaultFragmentsLayer": "coap",
            "DefaultPacketLayer": "coap",
            "InitialState": "IDLE"
        }
    }
})/";
